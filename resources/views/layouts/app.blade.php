...
<head>
    ...
    <link href="{{ asset('backendassets/demo/demo.css') }}" rel="stylesheet" />
...
<body>
    ...
    <script src="{{ asset('backendjs/core/popper.min.js') }}"></script>
    <script src="{{ asset('backendjs/core/bootstrap-material-design.min.js') }}"></script>
    <script src="{{ asset('backendjs/plugins/perfect-scrollbar.jquery.min.js') }}"></script>
